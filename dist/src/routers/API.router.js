...
router.get('/products', product_controllers_1.ProductControllers.listProduct);
router.get('/product/:id/detail', product_controllers_1.ProductControllers.detailProduct);
